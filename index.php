...
<iframe src="https://towns.cz/onlymap" width="100%" height="100%" frameborder="0"></iframe>
    ...
    <nav class="menu">
        ...
        <ul class="menu-list menu-list-left">
            ...
            <li class="menu-list-item" style="margin-left: 15px; margin-top: 17px; margin-right: 5px;"><img src="img/resources.png" alt=""/></li>
        </ul>

        <ul class="menu-list menu-list-right">


            <li class="menu-list-item menu-list-item-registration"><a href="#" id="popup-story-trigger">Dokončit registraci</a></li>

            <li class="menu-list-item menu-list-item-icon" id="popup-notification-trigger"><img src="img/notification.png" alt="notification"/></li>
    ...
    <aside class="sidebar">
        ...
        <div class="sidebar-action-wrapper">
            ...
            <div class="sidebar-action-popup">
                ...
                <div class="sidebar-action-close"><img src="img/close-white.png" alt=""/></div>
            </div>
        </div>
    ...
    <div class="popup-story-wrapper">
        <div class="popup-story-header">
            Príbeh
        </div>
